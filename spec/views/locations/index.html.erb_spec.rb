...
describe "/locations/index.html.erb" do
  ...
  before(:each) do
    ...
    location_98.should_receive(:lat).and_return("9.99")
    location_98.should_receive(:lng).and_return("9.99")
    ...
    location_99.should_receive(:lat).and_return("9.99")
    location_99.should_receive(:lng).and_return("9.99")
